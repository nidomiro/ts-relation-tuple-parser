...
import { ANTLRErrorListener, Recognizer, Token, AbstractParseTreeVisitor } from 'antlr4ng'
import { RelationTuple } from './relation-tuple.js'
import { RelationTupleSyntaxError, RelationTupleSyntaxErrorDetail } from './errors/relation-tuple-syntax.error.js'

const DEFAULT_TUPLE: RelationTuple = { namespace: '', object: '', relation: '', subjectIdOrSet: '' }
